...
import { GAME_ASSETS, ASSET_CATEGORIES } from '@/data/asset-map'
import { getAllCompletedChallenges, useWorkshopState } from '@/stores/workshopStore'
import type { GameAsset } from '@/data/asset-map'
